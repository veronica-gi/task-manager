...
- Create new tasks.  
- Move tasks between **Pending**, **In-Progress**, and **Completed** columns.  
- Delete tasks.  
- Responsive design for mobile devices.  
- Code separation into:
  - `ui` → Visual components (Task List)  
  - `core` → Business logic (Task Service, Task model)
